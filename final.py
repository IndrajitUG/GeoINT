...
#     """Create the HTML for the OpenLayers map"""
#     return f"""
#     <!DOCTYPE html>
#     <html>
#       <head>
#         <meta name="viewport" content="initial-scale=1,maximum-scale=1,user-scalable=no" />
#         <title>Display WFS data on a map</title>
...
def create_map_html(wfs_url):
    """Create the HTML for the OpenLayers map with a loading delay"""
    return f"""
    <!DOCTYPE html>
    <html>
      <head>
      ...
      <body>
        ...
        <div id="overlay"></div>
        <script>
          // Function to show map after delay
          function showMap() {{
          ...
          // Add 2 second delay before fetching and displaying data
          setTimeout(() => {{
            fetch(wfsUrl)
              .then(response => response.json())
              .then(data => {{
